  ...
  <div class="container page_height py-5">
    ...
    <div class="row">
      ...
      <div class="col-md-10">
        ...
        <div class="row my-5">
          <div class="col-md-6 mb-4" v-for="item in products[currentPage]" :key="item.id">
        ...
        <nav aria-label="Page navigation example">
          <ul class="pagination d-flex justify-content-center">
            ...
            <li class="page-item" v-for="page in products.length" :key="page":class="{'active': currentPage === page - 1}">
              <a class="page-link" href="#" @click="currentPage = page - 1">{{ page }}</a>
            </li>
            <li class="page-item" :class="{'disabled': currentPage == products.length -1}">
